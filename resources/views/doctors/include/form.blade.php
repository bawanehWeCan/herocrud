<div class="row mb-2">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ isset($doctor) ? $doctor->name : old('name') }}" placeholder="{{ __('Name') }}" required />
            @error('name')
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4 text-center">
                    ...
                    @else
                        <img src="{{ asset('storage/uploads/images/' . $doctor->image) }}" alt="Image" class="rounded mb-2 mt-2" width="200" height="150" style="object-fit: cover">
                    @endif
                </div>
